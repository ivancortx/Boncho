...
export const AddProductForm: React.VFC = () => {
  const dispatch = useDispatch(),
    ...
    [isDownButton, setIsDownButton] = useState<boolean>(false)
    ...
    >
      <div className={styles.container}>
        <Form className={styles.form}>
            ...
            <div className={styles.fieldInput}>
              <div className={styles.loadImageContainer}>
                ...
                <div className={styles.spinner}>
                  {!isUploaded && <Spinner animation="border" size="sm" />}
                </div>
              </div>
          ...
          <div className={styles.auctionParametersLine}>
            <h3>Параметры аукциона</h3>
          </div>
          ...
          <div className={styles.btn}>
            ...
            <div className={styles.messageAddProduct}>
              {isDownButton && <span>Товар успешно добавлен!</span>}
            </div>
          </div>
        </Form>
      </div>
