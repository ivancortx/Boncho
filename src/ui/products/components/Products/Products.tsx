        ...
        <div className={styles.itemContainer}>
          {productsData.map((product) => (
            <NavLink
              ...
              to={`/auctions-page/${product.auctionId}`}
              key={product.auctionId}
            >
              <div className={styles.item}>
                <div className={styles.photo}>
                  {!product.isInStock && (
                    <img src={sold_out} className={styles.isInStock} alt={'sold out'} />
                  )}
                  <img
                    className={
                      !product.isInStock ? `${styles.image} ${styles.soldOut}` : styles.image
                    }
