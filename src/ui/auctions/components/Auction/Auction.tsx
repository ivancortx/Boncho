    ...
    <div className={styles.item} key={auct.auctionId}>
      <NavLink className={styles.photo} to={`/auctions-page/${auct.auctionId}`}>
        <div className={styles.photo}>
          {!auct.isInStock && <img src={soldOut} className={styles.isInStock} alt={'sold out'}/>}
          {auct.photoUrlsData[0] ? (
            <img
              className={!auct.isInStock ? `${styles.image} ${styles.soldOut}` : styles.image}
      ...
      <div className={styles.itemContent}>
        ...
        <div className={styles.price}>
          ...
          <div className={styles.priceData}>
            <span>{auct.seePrice} $</span>
          </div>
        </div>
      </div>
      <NavLink to={`/auctions-page/${auct.auctionId}`}>
